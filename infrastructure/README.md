...
# test the build
docker run --rm -p 3001:3333 -e PORT='3333' -e POSTGRES_HOST='172.17.0.1' -e POSTGRES_PORT=5432 -e POSTGRES_USER=postgres -e POSTGRES_PASSWORD=password -e POSTGRES_DB=test --name nestjs-fargate-test $TAG_REPO:$TAG_SUFFIX
...
ECR_REPOSITORY_SUFFIX=repo-cb2e401
